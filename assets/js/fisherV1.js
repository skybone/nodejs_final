...
// Fish AJAX/JSON
	...
	function get_fish(jSurl){ // grabs data from json
        ...
        document.getElementById("displayFish").innerHTML="<p class='dispFish'>" + jSurl.fish_types[0].id + "<br>" + "Name:" + " " + jSurl[0].fishName + "<br>" + "Also known as:" + " " + jSurl[0].shortName + "</p>" + "<br>" + "<img class='responsive' src=" + jSurl[0].imageURL + ">";
          /*initialize(name); */ 
